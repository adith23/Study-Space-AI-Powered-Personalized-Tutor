...
class Space(Base):
    ...
    files = relationship("UploadedFile", back_populates="space", cascade="all, delete-orphan")
    chat_sessions = relationship("ChatSession", back_populates="space", cascade="all, delete-orphan")
    flashcard_decks = relationship("FlashcardDeck", back_populates="space", cascade="all, delete-orphan")
    quizzes = relationship("Quiz", back_populates="space", cascade="all, delete-orphan")
    videos = relationship("GeneratedVideo", back_populates="space", cascade="all, delete-orphan")
